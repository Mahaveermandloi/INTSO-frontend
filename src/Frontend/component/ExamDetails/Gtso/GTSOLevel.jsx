      ...
      <div className="lg:px-24 px-6 max-w-screen-xl mx-auto ">
        <div className=" flex flex-col py-7 justify-center items-center">
          ...
          <p className="text-center sm:px-12 px-6 mt-5">
            ...
            International Social science, GK & Current Affairs Olympiad Exams (IMO) individually for the
            academic year 2023-24. Social science, GK & Current Affairs Olympiad IMO has TWO Rounds of
            Examination.
          </p>
        </div>
        <div className="grid md:grid-cols-2 grid=cols-1 mt-16 gap-y-6">
          ...
          <p className="flex flex-col">
            ...
            IMO Social science, GK & Current Affairs Olympiad Round 1 follows CBSE, ICSE and other State boards
        ...
        <div className="grid md:grid-cols-2 grid=cols-1 mt-10 gap-y-6">
          <p className="flex flex-col">
            ...
            IMO Social science, GK & Current Affairs Olympiad Round 2 is the final round exam. Students
